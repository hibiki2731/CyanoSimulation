...
public:
	LinearDefaultBuffer(ID3D12Device& device, class CommandManager& commandManager, UINT sizeInBytes, D3D12_RESOURCE_STATES state, D3D12_RESOURCE_FLAGS flag = D3D12_RESOURCE_FLAG_NONE);
